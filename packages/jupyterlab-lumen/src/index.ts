...
namespace CommandIDs {
  export const openNotebookMindMap =
    "jupyterlab-lumen:open-notebook-mindmap";
  export const addMindMap = "jupyterlab-lumen:add-mindmap";
  export const insertCellBelow = "jupyterlab-lumen:insert-cell-below";
  export const cutCell = "jupyterlab-lumen:cut-cell";
  export const copyCell = "jupyterlab-lumen:copy-cell";
  export const pasteCellBelow = "jupyterlab-lumen:paste-cell-below";
}
...
const plugin: JupyterFrontEndPlugin<void> = {
  ...
  activate: (
    ...
    app.commands.addCommand(CommandIDs.openNotebookMindMap, {
      label: trans.__("Lumen"),
      caption: trans.__("Open this notebook in the Lumen mind map view"),
    ...
    toolbarRegistry.addFactory(
      ...
      (panel: NotebookPanel) =>
        new ToolbarButton({
          className: "jp-LumenNotebookOpenButton",
          label: trans.__("Lumen"),
          tooltip: trans.__("Open this notebook in the Lumen mind map view"),
          onClick: () => {
    ...
    console.info("jupyterlab-lumen: refactor extension activated");
  },
};
